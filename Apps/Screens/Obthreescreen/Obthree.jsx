...
import Obthree from './Apps/Screens/Obthreescreen/Obthree';


export default function Obthree() {
  ...
  return (
    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
      <Image source={require('./../../../assets/images/car1.png')} style={styles.loginImage} />
      <Text style={styles.headerText}>Find Parking </Text>
      <View style={styles.menuIconContainer}> {/* Wrap Ionicons in a View */}
        <Text style={styles.paragraph}>Find your perfect parking space wherever and whenever you need.</Text>
